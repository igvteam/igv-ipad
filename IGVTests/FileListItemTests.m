...
- (void)testFileListItemCreationWithNilLabel {
    ...
    FileListItem *fileListItem = [[[FileListItem alloc] initWithPath:@"http://www.broadinstitute.org/igvdata/1KG/pilot2Bams/NA12878.SLX.bam" label:nil genome:nil ] autorelease];
