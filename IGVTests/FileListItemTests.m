...
- (void)testFileListItemCreationWithNilLabel {
    ...
    FileListItem *fileListItem = [[[FileListItem alloc] initWithFilePath:@"http://www.broadinstitute.org/igvdata/1KG/pilot2Bams/NA12878.SLX.bam" label:nil genome:nil indexPath:nil] autorelease];
